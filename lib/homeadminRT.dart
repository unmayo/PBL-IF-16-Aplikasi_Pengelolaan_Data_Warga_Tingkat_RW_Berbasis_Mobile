...
import 'package:pendawa/profileC.dart';
import 'package:pendawa/settings.dart';
import 'package:http/http.dart' as http;
import 'package:pendawa/api.dart';

class MyHomeAdminRT extends StatelessWidget {
  const MyHomeAdminRT({Key? key});

  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: HomeAdminRTPage(),
    );
  }
}

class HomeAdminRTPage extends StatefulWidget {
  const HomeAdminRTPage({Key? key}) : super(key: key);

  @override
  _HomePageAdminRTState createState() => _HomePageAdminRTState();
}

class _HomePageAdminRTState extends State<HomeAdminRTPage> {
    ...
    if (response.statusCode == 200) {
      ...
      if (userData.containsKey("error")) {
        ...
        setState(() {
          ...
          userRT = nort;
          // Convert userRT to a string and store it in userRTText
          userRTText = userRT.toString();
          print(userName);
          print(userImage);
          print(userRT);
          RT().resetValues();
                  ...
                  child: MaterialButton(
                    child: Padding(
                      padding: EdgeInsets.only(
                          right: 80), // Adjust the right padding
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        mainAxisAlignment:
                            MainAxisAlignment.end, // Align content to the end
                        children: [
                          Text(
                            'Hello! RT $userRTText',
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () {
                          ...
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => const ProfilePageC(),
                            ),
                          );
                        },
                        child: Text(
