...
class MyProfileB extends StatelessWidget {
  const MyProfileB({Key? key});
...
class ProfilePageB extends StatefulWidget {
  const ProfilePageB({Key? key}) : super(key: key);

  @override
  State<ProfilePageB> createState() => _ProfilePageState();
}

class _ProfilePageState extends State<ProfilePageB> {
