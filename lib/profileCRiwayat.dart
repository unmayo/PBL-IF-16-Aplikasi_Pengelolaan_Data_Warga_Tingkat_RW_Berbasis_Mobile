...
import 'package:pendawa/prosesC.dart';
...
class MyProfileCriwayat extends StatelessWidget {
  const MyProfileCriwayat({Key? key});

  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: ProfilePageCriwayat(),
    );
  }
}

class ProfilePageCriwayat extends StatefulWidget {
  const ProfilePageCriwayat({Key? key}) : super(key: key);

  @override
  State<ProfilePageCriwayat> createState() => _ProfilePageState();
}

class _ProfilePageState extends State<ProfilePageCriwayat> {
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => const ProsesCPage()));
                        },
                        child: Text(
                          'Proses Pengajuan',
                          style: primaryTextstyle.copyWith(
