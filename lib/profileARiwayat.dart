...
import 'package:pendawa/statuspengajuan.dart';
...
class Biodata {
  ...
  Biodata({
    ...
    required this.nounik,
    required this.suratpath,
  });
}

class MyProfileAriwayat extends StatelessWidget {
  const MyProfileAriwayat({Key? key});

  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: ProfilePageAriwayat(),
    );
  }
}

class ProfilePageAriwayat extends StatefulWidget {
  const ProfilePageAriwayat({Key? key}) : super(key: key);

  @override
  State<ProfilePageAriwayat> createState() => _ProfilePageState();
}

class _ProfilePageState extends State<ProfilePageAriwayat> {
  ...
  Future<void> fetchData() async {
    ...
    final response = await http.post(
      Uri.parse(Api.getRiwayat), // Replace with your PHP script URL
      body: {'nik': nikB},
    );
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () {
                          RiwayatUser().resetValues;
                          RiwayatUser().Deskripsi = '${biodata.deskripsi}';
                          RiwayatUser().no_unik = '${biodata.nounik}';
                          RiwayatUser().jenis_surat = '${biodata.surat}';
                          RiwayatUser().surat_path = '${biodata.suratpath}';
                          Navigator.push(
                              context,
                              MaterialPageRoute(
