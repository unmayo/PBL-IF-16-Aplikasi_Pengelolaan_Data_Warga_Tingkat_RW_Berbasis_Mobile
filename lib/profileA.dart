...
class MyProfileA extends StatelessWidget {
  const MyProfileA({Key? key});
...
class ProfilePageA extends StatefulWidget {
  const ProfilePageA({Key? key}) : super(key: key);

  @override
  State<ProfilePageA> createState() => _ProfilePageState();
}

class _ProfilePageState extends State<ProfilePageA> {
